...
def test_str():
    with start_protect_unprotect_mocking():
        ...
        # reprotected = session.reprotect(protected, "name","SUCCESS_REPROTECT_STR")
...
def test_str_exiv():
    with start_protect_unprotect_mocking():
        ...
        # reprotected = session.reprotect(protected, "name","SUCCESS_REPROTECT_STR",old_external_iv=bytes("oldexiv","utf-8"),new_external_iv=bytes("newexiv","utf-8"))
