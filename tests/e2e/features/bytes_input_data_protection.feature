Feature: Successful Protection Operations For Bytes Input Data
    ...
    I want to perform protect and unprotect operations on bytes input data
    ...
    Scenario: Tokenize and Detokenize single bytes input data
        When the user performs "tokenization" operations on the "single bytes" input data using the following data elements
        ...
        And all the data should be written to a file "token_bytes.txt"

    @encryption @single
    Scenario: Encyrpt and Decrypt single bytes input data
        When the user performs "encryption" operations on the "single bytes" input data using the following data elements
            | data_element | input_data                                                                                                                    |
        ...
        Then all the data is validated
        And all the data should be written to a file "encrypt_bytes.txt"
    ...
    Scenario Outline: Encyrpt and Decrypt bulk input data passed as a "<input_type>"
        ...
        Examples:
            ...
            | list of bytes  | encrypt_list_of_bytes.txt  |
            | tuple of bytes | encrypt_tuple_of_bytes.txt |
    ...
    Scenario: Tokenize and Detokenize single bytes input data with External Initialization Vector (EIV)
        When the user performs "tokenization" operations on the "single bytes" input data using the following data elements and external IV
        ...
        And all the data should be written to a file "token_bytes_IV.txt"
    ...
    Scenario Outline: Tokenize and Detokenize bulk input data passed as a "<input_type>"
        When the user performs "tokenization" operations on the "<input_type>" using the following data elements
            ...
            | datetime     | ["2023-09-04 14:30:00", "2022-08-05T10:15:00", "0600-01-01 00:00:00 000", "1970-04-02 07:00:58 369000", "2019-05-08 16:20:00", "3337-11-27 23:59:59 999", "1931.07.16 15:29:24 838467", "1958/06/30 11:38:03 051"]                                                                                                       |
            | datetime     | ["2023-09-04", "2022-08-05", "2021-07-06", "2020-06-07", "2019-05-08", "2018-04-09", "2017-03-10", "2016-02-11"]                                                                                                                                                                                                         |
            | datetime_yc  | ["2023-09-04 14:30:00", "2022-08-05T10:15:00", "0600-01-01 00:00:00 000", "1970-04-02 07:00:58 369000", "2019-05-08 16:20:00", "3337-11-27 23:59:59 999", "1931.07.16 15:29:24 838467", "1958/06/30 11:38:03 051"]                                                                                                       |
        ...
        Examples:
            | input_type     | output_file              |
            | list of bytes  | token_list_of_bytes.txt  |
            | tuple of bytes | token_tuple_of_bytes.txt |
    ...
    Scenario Outline: Tokenize and Detokenize bulk input data passed as a <input_type> with External Initialization Vector (EIV)
        ...
        Examples:
            | input_type     | output_file                 |
            | list of bytes  | token_list_of_bytes_IV.txt  |
            | tuple of bytes | token_tuple_of_bytes_IV.txt |